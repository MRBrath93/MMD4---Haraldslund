...
// dropdownRef.value bruges til at få fat i det element, der refereres til af dropdownRef.
...
// Funktion til at håndtere klik på dropdown-menuen. Når brugeren vælger et punkt i menuen, opdateres den valgte label og dropdown-menuen lukkes.
// "item" er det valgte punkt i menuen og dets label sendes fra router-linket. 
